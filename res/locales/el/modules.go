...
func init() {
	modules.RegisterModules("el", []modules.Module{
...

		{
			...
			Patterns: []string{
				"Μου αρέσουν οι ταινίες δράσεις και κινουμένων σχεδίων",
				"Βλέπω ταινίες επιστημονικής φαντασίας",
			},
			Responses: []string{
				"Πολύ καλές επιλογίες. Τις αποθήκευσα στα στοιχεία σου.",
...

		{
			...
			Patterns: []string{
				...
				"Σημέιωσε ότι έχω εξετάσεις",
				"Θύμισε μου ότι έχω ένα συνέδριο άυριο το πρωϊ στις 9πμ",
			},
			Responses: []string{
